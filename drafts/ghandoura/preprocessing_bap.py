...
def preprocess_file(file_path, new_file_path=None, sfreq=None, references=[], filters={}):    
    ...
    return eeg_obj, None if new_file_path is None else None, new_file_path
            ...
            if 'preprocessed' in dirs:
                for file_name in tqdm(file_names):
                    ...
                    if os.path.splitext(file_name)[1] == ".vhdr":
                        ...
                        pool.apply_async(preprocess_file, args=(file_path, new_file_path, sfreq, references, filters), callback=callback)
